    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#1B365D] mb-4">Privacy Policy</h1>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div className="border-t border-gray-200 px-4 py-5 sm:p-6 space-y-8">
            ...
            <section>
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">4. Disclosure of Your Information</h3>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">5. Your Rights Under Canadian Privacy Laws</h3>
              <p className="text-gray-700 mb-4">
